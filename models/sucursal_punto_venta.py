...
class SucursalPuntoVentaWizard(models.TransientModel):
    ...
    punto_venta_actual = fields.Char(string="Punto de Venta Actual", readonly=True)
    nueva_sucursal = fields.Selection(selection='_get_sucursales', string="Código Nueva Sucursal")
    nuevo_punto_venta = fields.Selection(selection='_get_puntos_venta', string="Código Nuevo Punto de Venta")
